...
<div class="container" vertical-align="middle">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">電話番号を変更してください</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/editcontroll">
                        @csrf
                            ...
                            <div class="form-group row">
                                <label for="urgent_phone_number" class="col-md-4 col-form-label text-md-right">緊急時の電話番号</label>

                                <div class="col-md-6">
                                    <input id="urgent_phone_number" type="text" class="form-control @error('urgent_phone_number') is-invalid @enderror" name="urgent_phone_number" value="{{ old('urgent_phone_number') }}" autocomplete="urgent_phone_number">
